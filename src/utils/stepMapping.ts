...
export const SURVEY_STEPS: StepDefinition[] = [
  ...
  // Workout Preferences Steps (14-21)
  ...
  { id: 32, category: 'finalSteps', name: 'Start Commitment', description: 'When you want to start', requiresValidation: true },
];
